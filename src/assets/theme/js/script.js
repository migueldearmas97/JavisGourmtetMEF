const customInitFunctionGalleryTheme = () => {

    (function(a) {
        var f = a("html").hasClass("is-builder");
        a.extend(a.easing, { easeInOutCubic: function(a, b, d, e, l) { return 1 > (b /= l / 2) ? e / 2 * b * b * b + d : e / 2 * ((b -= 2) * b * b + 2) + d } });
        a.fn.outerFind = function(a) { return this.find(a).addBack(a) };
        a.fn.footerReveal = function() {
            function c() { b.outerHeight() <= e.outerHeight() ? (b.css({ "z-index": -999, position: "fixed", bottom: 0 }), b.css({ width: d.outerWidth() }), d.css({ "margin-bottom": b.outerHeight() })) : (b.css({ "z-index": "", position: "", bottom: "" }), b.css({ width: "" }), d.css({ "margin-bottom": "" })) }
            var b = a(this),
                d = b.prev(),
                e = a(window);
            c();
            e.on("load resize", function() { c() });
            return this
        };
        (function(a, b) {
            ...
            jQuery.fn[b] = function(a) { return a ? this.bind("resize", d(a)) : this.trigger(b) }
        })(jQuery, "smartresize");
        a.isMobile = function(c) {
            ...
            "*" == c ? b = a.map(d, function(a) { return a }) : c in d && b.push(d[c]);
        ...
        a(function() {
            ...
            function b(b) { setTimeout(function() { a(b).outerFind(".mbr-parallax-background").jarallax({ speed: .6 }).css("position", "relative") }, 0) }
                            ...
                            if (c && /vimeo/g.test(c[3])) {
                                ...
                                d.onreadystatechange = function() {
                                    if (4 === this.readyState)
                                        ...
                                        } else f && k.css("background-image", 'url("images/no-video.jpg")').show()
                                };
                                d.send();
                                d = null;
                                !a.fn.vimeo_player || f || a.isMobile() || a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().vimeo_player({ videoURL: b, containment: "self", showControls: !1, mute: !0 })
                            }
                        }
            ...
            a(window).smartresize(function() { a(".mbr-section--16by9").each(c) });
            ...
            if (f) a(document).on("add.cards", function(a) { d(a.target) });
            ...
            a(".cols-same-height .mbr-figure").each(function() {
                function b() {
                    ...
                    if (f && g) {
                        ...
                        l > a && (a = 100 * (l - a) / a, d.css({ width: a + 100 + "%", maxWidth: a + 100 + "%", marginLeft: -a / 2 + "%" }))
                    }
                }
                var c = a(this),
                    d = c.children("img"),
        ...
        if (!f) {
            if (a.fn.socialLikes) a(document).on("add.cards", function(c) { a(c.target).outerFind(".mbr-social-likes").on("counter.social-likes", function(b, c, e) { 999 < e && a(".social-likes__counter", b.target).html(Math.floor(e / 1E3) + "k") }).socialLikes({ initHtml: !1 }) });
            a(document).on("add.cards", function(c) { a(c.target).hasClass("mbr-reveal") && a(c.target).footerReveal() });
                    ...
                    d.on("scroll resize", function() {
                        ...
                        a.each(b, function() {
                            var b = a(this),
                                ...
                                h = g.offsetHeight,
                                g = c(g);
                            if (g + h >= d && g <= f && b.hasClass("hidden")) b.removeClass("hidden").addClass("fadeInUp").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() { b.removeClass("animated fadeInUp") })
                        })
                    });
                    d.trigger("scroll")
                }
        ...
        a(document).ready(function() {
            if (a(".mbr-arrow-up").length) {
                var c = a("#scrollToTop"),
                    ...
                    d = a(window);
                c.css("display", "none");
                d.scroll(function() { 0 < a(this).scrollTop() ? c.fadeIn() : c.fadeOut() });
                c.click(function() { b.animate({ scrollTop: 0 }, 400); return !1 })
            }
        });
        if (!f) a(".mbr-arrow").on("click", function(c) {
            ...
            c = c.offset();
            a("html, body").stop().animate({ scrollTop: c.top },
                800, "linear")
        });
        ...
        a(document).ready(function() {
            if (!f) {
                ...
                a("[data-modal]").click(function() { c(a(this)) })
            }
        });
        if (!f && !a.isMobile()) {
            var h = a("section.menu"),
                p = a(window).width();
            !h.find(".navbar").hasClass("collapsed") && 991 < p && (h.find("ul.navbar-nav li.dropdown").hover(function() { a(this).hasClass("open") || a(this).find("a")[0].click() }, function() {
                a(this).hasClass("open") &&
                    a(this).find("a")[0].click()
            }), h.find("ul.navbar-nav li.dropdown .dropdown-menu .dropdown").hover(function() { a(this).hasClass("open") || a(this).find("a")[0].click() }, function() { a(this).hasClass("open") && a(this).find("a")[0].click() }))
        }
        f || 0 != a(".mbr-slider.carousel").length && a(".mbr-slider.carousel").each(function() {
            var c = a(this),
            ...
            c.on("slide.bs.carousel", function() {
                ...
                c.carousel({ keyboard: !1 })
            }).on("slid.bs.carousel", function() {
                b.unbind("click");
                d.unbind("click");
                c.carousel({ keyboard: !0 });
...
customInitFunctionGalleryTheme();