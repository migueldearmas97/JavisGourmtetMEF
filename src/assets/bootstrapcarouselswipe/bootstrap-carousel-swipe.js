...
+ function(b) {
    if (b.fn.carousel) {
        var c = function(a) { this.$element = b(a);
        ...
        c.prototype.touchend = function(a) {
            if (this.options.swipe && this.$active) {
                ...
                40 < this.dx || 0 < this.dx && a > this.options.swipe ? this.carousel.prev() : -40 > this.dx || 0 > this.dx && a > this.options.swipe ? this.carousel.next() : this.$active.one(b.support.transition.end, function() { c.removeClass("prev next") }).emulateTransitionEnd(1E3 * this.$active.css("transition-duration").slice(0, -1));
                c.carousel_offset(!1);
        ...
        c.prototype.swipe = function(a) {
            ...
            if (0 > a) { this.$prev.carousel_offset(!1).removeClass("prev").carousel_transition(!0); if (!this.$next.length || this.$next.hasClass("active")) return;
        ...
        c.prototype.getActive = function() { this.$active = this.$element.find(".item.active");
            this.$items = this.$active.parent().children();
            this.$next = this.$active.next();!this.$next.length && this.options.wrap && (this.$next = this.$items.first());
            this.$prev = this.$active.prev();!this.$prev.length && this.options.wrap && (this.$prev = this.$items.last()); return this.$active };
        var e = b.fn.carousel;
        b.fn.carousel =
        ...
        b.fn.carousel_transition = function(a) { a = a ? "" : "none"; return this.each(function() { b(this).css("-webkit-transition", a).css("transition", a) }) };
        var f = function() {
        ...
        b.fn.carousel_offset = function(a) { return this.each(function() { a ? f ? b(this).css("transform", "translate3d(" + a + "%, 0, 0)") : b(this).css("left", a + "%") : b(this).css({ transform: "", left: "" }) }) };
        b(".carousel").carousel()
    }
}(jQuery);